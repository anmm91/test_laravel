...
{{--    <form class="form-horizontal" method="post" action="/player/update">--}}
    <form class="form-horizontal" method="post" action="{{route('player.update',$model->id)}}">
        @method('put')
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text"  name="name" value="{{$model->name}}" class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">title</label>
            <div class="col-sm-10">
                <input type="text" name="title" value="{{$model->title}}" class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">desc</label>
            <div class="col-sm-10">
                <input type="text" name="description" value="{{$model->description}}"  class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
