...
<table class="table table-hover table-sm table-dark">
    ...
    @foreach($records as $record)
        <tr>
            ...
            <td>
{{--                <a class="btn btn-primary xs" href="/player/{{$record->id}}/edit">edit</a>--}}
{{--                <a class="btn btn-primary xs" href="{{route('player.edit',$record->id)}}">edit</a>--}}
                <a class="btn btn-primary xs" href="{{action('PlayerController@edit',$record->id)}}">edit</a>
            </td>
            <td>
                <form method="post" action="{{action('PlayerController@destroy',$record->id)}}">
                    @method('delete')
                    @csrf
                    <button class="btn btn-danger xs" onclick="return confirm('are you sure to delete this item')">delete</button>
                </form>
            </td>
            <td>
                <a class="btn btn-primary xs" href="{{route('player.show',$record->id)}}">
                    single
                </a>
            </td>
...
<a class="btn btn-primary"  href="/player/create">create user</a>
