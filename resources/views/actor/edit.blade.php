...
<div class="container">
    <form class="form-horizontal" method="post" action="{{route('actor.update',$model->id)}}">
        @method('put')
        @csrf
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">name</label>
            <div class="col-sm-10">
                <input type="text"  value="{{$model->name}}" name="name" class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">age</label>
            <div class="col-sm-10">
                <input type="text"value="{{$model->age}}" name="age" class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">weight</label>
            <div class="col-sm-10">
                <input type="text" value="{{$model->weight}}"name="weight"  class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">length</label>
            <div class="col-sm-10">
                <input type="text" value="{{$model->length}}" name="length"  class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">nationality</label>
            <div class="col-sm-10">
                <input type="text"value="{{$model->nationality}}" name="nationality"  class="form-control" id="inputEmail3" placeholder="Email">
            </div>
        </div>
